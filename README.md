...
Một khuôn khổ back-end dựa trên Xray hỗ trợ giao thức V2ay, Trojan, Shadowsocks, rất dễ mở rộng và hỗ trợ kết nối đa bảng
...
2. `cd XrayR-release`
3. Chỉnh sửa config。
Định dạng cơ bản của hồ sơ như sau, nodes có thể thêm nhiều bảng điều khiển cùng một lúc, nhiều nút cấu hình thông tin, chỉ cần thêm nodes item ở cùng định dạng。
...
Thực hiện theo thư mục docker-compose.yml:
```
docker-compose pull
docker-compose up -d
```
